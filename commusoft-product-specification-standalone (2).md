...
graph TB
    ...
    subgraph "API Endpoints"
        CUSTOMER_API[Customers API<br/>GET, POST, PUT]
        JOB_API[Jobs API<br/>GET, POST, PUT]
        TECH_API[Technicians API<br/>GET availability]
        INVOICE_API[Invoices API<br/>GET, POST]
        PARTS_API[Parts API<br/>GET inventory]
    end
